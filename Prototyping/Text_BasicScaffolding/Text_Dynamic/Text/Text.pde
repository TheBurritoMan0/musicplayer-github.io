...
color ink, crispybrown=#C1884A, white=#FFFFFF, resetDefaultInk=white; //Not Night Mode Friendly
int size;
String freaky = "freaky", dokkan="dokkan font goes hard", john="trying my best ong";
//
void setup()
{
  //Display
...
void draw()
{
  ...
  //
  ink = color( random(0,360), random(360), random(360));
  //
  fill(ink);
